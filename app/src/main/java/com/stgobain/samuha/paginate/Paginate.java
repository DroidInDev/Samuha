...
public abstract class Paginate {
    ...
    public interface Callbacks {
         ...
         * {@link com.stgobain.samuha.paginate.Paginate.Callbacks#onLoadMore} won't be called.
         *
         ...
         * com.stgobain.samuha.paginate.Paginate.Callbacks#onLoadMore} won't be called and loading row, if used, won't be added.
         *
